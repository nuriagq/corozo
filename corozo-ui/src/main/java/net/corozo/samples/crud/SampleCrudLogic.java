package net.corozo.samples.crud;

import net.corozo.CorozoUI;
import net.corozo.samples.backend.DataService;
...
public class SampleCrudLogic implements Serializable {
    ...
    public void init() {
        ...
        if (!CorozoUI.get().getAccessControl().isUserInRole("admin")) {
    ...
    private void setFragmentParameter(String productId) {
        ...
        Page page = CorozoUI.get().getPage();
        page.setUriFragment(
