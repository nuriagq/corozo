...
- corozo-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- corozo-ui: main application module, development time
- corozo-production: module that produces a production mode WAR for deployment
