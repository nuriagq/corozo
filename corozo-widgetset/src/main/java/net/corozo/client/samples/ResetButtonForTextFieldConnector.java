package net.corozo.client.samples;
...
import net.corozo.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@net.corozo.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
